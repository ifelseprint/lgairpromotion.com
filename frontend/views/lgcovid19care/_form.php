  ...
  <div class="container">
    ...
    <div class="row" style="margin-bottom: 40px;">
      <div class="col-sm-12">
        ...
        <div class="form-group-sm row" style="margin-bottom: 10px;">
          ...
          <div class="col-sm-4">
            <?= $form->field($Register, 'TEL')->textInput(['class' => 'form-control form-control-sm','id'=>'TEL','required'=> true,'onkeypress' =>'return appLG.App.OnlyNumbers(event)','pattern'=> '^0[0-9]{9,10}','maxlength' =>'10','data-msg'=>'ข้อมูลเบอร์โทรศัพท์ไม่ถูกต้อง และห้ามเป็นค่าว่าง'])?>
    ...
    <div class="row" style="margin-bottom: 20px;">
      <div class="col-md-12">
        ...
        <div class="form-group-sm row" style="margin-bottom: 10px;">
          <div class="col-sm-12">
            <div>2. ท่านมีประกันที่คุ้มครองการเจ็บป่วยด้วยโรคติดเชื้อจากไวรัสโคโรนา 2019 (COVID-19) จากบริษัทสินทรัพย์ประกันภัย หรือไม่</div>
